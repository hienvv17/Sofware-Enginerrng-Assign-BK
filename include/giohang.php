...
<div class="cart">
    ...
    <?php }else{ ?>
        <div class="text-center mt-2 mb-2 title-cart">
        Thực đơn bàn số <?php echo $so_ban ?>
        </div>
    <?php }
    ...
    <div class="row d-flex justify-content-center ">
        ...
        <div class="col-6">
            ...
            <p class="d-flex justify-content-center">
                <i class="far fa-minus-square effect_icon" style="color: black;" id="giam_sl" id_mon="<?php echo $row_mon['id_mon'] ?>">&nbsp</i>
                <u class="amount-cart"><?php echo $row_mon['so_luong']?></u>&nbsp
                <i class="far fa-plus-square effect_icon" style="color: black;" id="tang_sl" id_mon="<?php echo $row_mon['id_mon'] ?>">&nbsp &nbsp</i>
    ...
    <form  action="#" method="POST">
        ...
        <input hidden id="hidden-field" name="dimensions" value="">
                    <script>
                    document.getElementById('hidden-field').value = screen.width;
                    </script>
            <button type="submit" name="hoan_tat" class="col-auto btn btn-outline-primary">HOÀN TẤT</button>
        </div>
    </form>
    <?php ;} else {?>
    <div class="mt-5 mb-5 text-center notice-cart">Thực đơn đang trống
        <i class="far fa-grin-hearts fa-lg" style="color: black;"></i>
    </div> 
    <?php }?> 
</div> 
