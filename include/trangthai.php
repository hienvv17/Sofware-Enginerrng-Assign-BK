...
if(isset($_SESSION['hoan_tat'])){
	if ( isset($_POST['dimensions']) && $_POST['dimensions'] > 767){
	?>
	...
	<?php } else{ ?>
		<div class="container-fluid">
		<div class="row ">
			<center><div class="col-md-4"><?php include('hoantat.php');?></div></center>
...
<?php }} elseif (isset($_SESSION['thanh_toan'])){
	...
	<?php } else{ ?>
		<div class="container-fluid">
		<div class="row ">
			<center><div class="col-md-4"><?php include('danhgia.php');?></div></center>
...
<?php }} elseif (isset($_SESSION['feedback'])){ 
	...
	<?php } else{ ?>
		<div class="container-fluid">
		<div class="row ">
			<center><div class="col-md-4"><?php include('ketthuc.php');?></div></center>
